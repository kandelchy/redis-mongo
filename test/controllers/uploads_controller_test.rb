...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { messagecode: @upload.messagecode, messagetext: @upload.messagetext } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { messagecode: @upload.messagecode, messagetext: @upload.messagetext } }
